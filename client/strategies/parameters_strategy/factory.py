"""
Factory for parameters strategies.

This module implements the Factory pattern for creating parameters strategies.
"""
...
class ParametersStrategyFactory:
    """
    Factory for creating parameters strategies.
    ...
    def create(cls, config: ParametersStrategyConfig) -> ParametersStrategy:
        ...
        """
        logger.info(f"Creating parameters strategy: {config.name}")
